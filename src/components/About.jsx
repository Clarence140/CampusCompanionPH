...
export default function About() {
  ...
  return (
    <div className="w-full">
      ...
      {/* About the Website - Standalone Card */}
      ...
      {/* Goals and Mission */}
      <div className="mb-8">
        <h3 className="text-xl sm:text-2xl font-heading font-bold mb-6 flex items-center text-gray-900">
          <FiTarget className="mr-3 text-purple-600" size={28} /> Our Goals &
          Mission
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 sm:p-5 rounded-lg bg-slate-50">
      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          ...
          <button
            ...
            className="flex items-center px-3 py-1.5 rounded-lg transition-colors bg-slate-100 hover:bg-slate-200 text-gray-600 text-sm"
          >
            {showTips ? (
              <>
      ...
      {/* About the Developer */}
      <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
        <h3 className="text-xl sm:text-2xl font-heading font-bold mb-4 flex items-center text-gray-900">
