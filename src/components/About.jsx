    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">
            The application features dark mode support, responsive design for
        ...
        {/* Goals and Mission */}
        <div className="mb-8">
          <h3 className="text-2xl font-heading font-bold mb-6 flex items-center text-gray-900 dark:text-gray-100">
            <FiTarget
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-2xl font-heading font-bold flex items-center text-gray-900 dark:text-gray-100">
              <FiBook
